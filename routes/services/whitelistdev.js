module.exports = function(app) {
    app.get('/services/whitelist/dev', async(req, res) => {
        ...
        con.query("SELECT * FROM users WHERE isMuted = 0 AND (isBeta = 1 OR dept = 'Development' OR dept = 'Admin')", async (err, rows) => {
            const hexes = [];
            ...
            console.log("FiveM Dev Server whitelist has been refreshed");
        })
    })
}